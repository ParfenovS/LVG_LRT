...
// taken from http://kluge.in-chemnitz.de/opensource/spline/
// see also https://github.com/ttk592/spline/
...
public:
    band_matrix() noexcept {};                             // constructor
...
public:
    ...
    spline() noexcept : m_left(second_deriv), m_right(second_deriv),
