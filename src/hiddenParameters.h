...
#define MAX_NEWT_SCALE_STEP 1.e-3                       // maximum step of the Newton step scale to find the numerical derivative of the objective function used in bisection method
