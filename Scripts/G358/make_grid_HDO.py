...
RESULTED_GRID_FILENAME = "grid_HDO.txt"
...
GAS_TEMPERATURES = numpy.arange(50, 310, 10)
#GAS_TEMPERATURES = [80]
SPECIFIC_COLUMN_DENSITIES = numpy.array([1.7e13])
COLLISION_PARTNERS_FRACTIONS = [1.0]  # partners for CH3OH: H2 , He
#### ***************
INITIAL_SOLUTION = 2 # 0 - from file; 1 - optically thin; 2 - LTE
INITIAL_SOLUTION_FILENAME = "Populations/Pn.txt"
FILE_WITH_LAMDA_DATA = "hdo.dat"
MAXIMUM_DpopDt_OR_popDiff = 1.e-10
MAXIMUM_NUMBER_OF_ITERATIONS = 5000000
BEAMING = [1.0]
LINE_WIDTH = 0.1
LIST_OF_TRANSITIONS = [1, 37]
...
def prepare_input(pars, in_pops_file="", out_pops_file=""):
    ...
    cin += "# WHII	turnFreq [Hz]		Te [K]		HII region is at LOS (1) or not (0)\n"
